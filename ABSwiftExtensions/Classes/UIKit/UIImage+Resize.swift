...
public extension UIImage {
    ...
    public func resizedImage(maxSize: CGSize, interpolationQuality quality: CGInterpolationQuality) -> UIImage {
        return resizedImage(size.sizeThatFits(size: maxSize), interpolationQuality: quality)
    }
    ...
    public func borderedImage(width: CGFloat, borderColor: UIColor) -> UIImage? {
    ...
    public func insetImage(_ inset: UIEdgeInsets, color: UIColor? = nil) -> UIImage? {
    ...
    public func insetImage(dx: CGFloat, dy: CGFloat, color: UIColor? = nil) -> UIImage? {
